...
public class UserOperationService {
	 ...
	 * 
	 * @param userRoleRequest A DTO containing the details required to create a
	 *                        user, including username, password, email, phone
	 *                        number, department, and role.
	 * @return The created User entity, including the assigned roles, after being
	 *         saved to the repository.
	 * @throws RuntimeException if the role specified in the request is not found in
	 ...
	 * @param userRoleRequest A DTO containing the new data for the user and the
	 *                        role to be assigned.
	 * @return The updated User entity, including the new role after being saved to
	 *         the repository.
	 * @throws RuntimeException if the user with the specified ID is not found or if
	 *                          the role specified in the request is not found.
	 */
