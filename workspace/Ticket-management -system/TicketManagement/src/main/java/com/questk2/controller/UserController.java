...
/**
 * Controller class for handling user-related operations. Provides endpoints to
...
public class UserController {
	 ...
	 *
	 * @param userRoleRequest The data transfer object containing user details and
	 *                        role.
	 ...
	 *
	 * @return ResponseEntity returns either: The User object if login is successful
	 *         or A message indicating invalid credentials
	 */
	@PostMapping("/login")
